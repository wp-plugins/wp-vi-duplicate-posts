...
<?php _e( 'has following plugins for you', 'wvpd' ); ?>:
</h3>
<ul class="">
...
<div class="bottom">
	...
	<a href="http://bit.ly/1HZGRBg" target="_blank"><img class="donate" src="<?php echo plugins_url( 'assets/banner2.png' , __FILE__ ); ?>" width="336" height="280" title="<?php _e( 'Donate Here', 'wvpd' ); ?>"></a>		
  </div> 
</div>
